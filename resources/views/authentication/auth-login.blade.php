            ...
            <div class="card-content">
              <div class="card-body">
                ...
                <div class="divider">
                  ...
                  <form method="POST" action="{{asset('attemp-login')}}">
                    {{method_field('post')}}
                    @csrf
                    <div class="form-group mb-50">
                      <!-- <label class="text-bold-600" for="exampleInputEmail1">Email address</label> -->
                      <input type="number" name="pernr" class="form-control" id="pernr" placeholder="Personal Number">
                    </div>
                    ...
                    <button type="submit" name="signin" value="signin" class="btn btn-primary glow w-100 position-relative"> 
                      Log In
